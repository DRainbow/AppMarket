...
import com.android.sugar.appmarket.ui.widget.IndicatorView;
...
/**
 * @ClassName: HomePictureHolder
 * @Description:
 * @author: SugarT
 * @date: 16/7/25 上午11:06
 */
public class HomePictureHolder extends BaseHolder<List<String>> implements ViewPager.OnPageChangeListener {
    ...
    protected View initView() {
        ...
        AbsListView.LayoutParams al = new AbsListView.LayoutParams(LayoutParams.MATCH_PARENT, UIUtils.getDimens(R
                .dimen.list_header_hight));
        mHeader.setLayoutParams(al);

        mViewPager = new ViewPager(UIUtils.getContext());
        RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams
                .MATCH_PARENT);
