...
public class AppDetailSafeHolder extends BaseHolder<AppInfo> implements OnClickListener {
    ...
    private void expand() {
        final ViewGroup.LayoutParams params = mContentLayout.getLayoutParams();
        int targetHeight;
    ...
    private int measureContentHeight() {
        ...
        mContentLayout.getLayoutParams().height = ViewGroup.LayoutParams.WRAP_CONTENT;
