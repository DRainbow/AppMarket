...
import com.android.sugar.appmarket.bean.DownloadInfo;
import com.android.sugar.appmarket.manager.DownloadManager;
import com.android.sugar.appmarket.ui.widget.ProgressHorizontal;
import com.android.sugar.appmarket.utils.UIUtils;

/**
 * @ClassName: AppDetailBottomHolder
 * @Description:
 * @author: SugarT
 * @date: 16/7/18 下午8:26
 */
public class AppDetailBottomHolder extends BaseHolder<AppInfo> implements View.OnClickListener, DownloadManager
        .DownloadObserver {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.detail_progress:
                if (mState == DownloadManager.STATE_NONE || mState == DownloadManager.STATE_PAUSED || mState ==
