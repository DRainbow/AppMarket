...
/**
 * @ClassName: AppDetailDesHolder
 * @Description:
 * @author: SugarT
 * @date: 16/7/25 上午11:00
 */
public class AppDetailDesHolder extends BaseHolder<AppInfo> implements View.OnClickListener {
    ...
    private int measureShortHeight() {
        ...
        int widthMeasureSpec = MeasureSpec.makeMeasureSpec(width, View.MeasureSpec.EXACTLY);
